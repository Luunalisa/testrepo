...
def get_pie_char(selected_site):
    if selected_site == 'ALL':
        ...
        fig = px.pie(success_fail_counts, values='Count', names='Outcome',title=f'Success vs. Failure for site {selected_site}')
    return fig
...
def update_scatter_chart(selected_site, payload_range):
    ...
    # Create scatter plot
    fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class',color='Booster Version Category',title='Payload vs. Launch Success',labels={'class': 'Launch Success (1=Success, 0=Failure)'},hover_data=['Launch Site'])
